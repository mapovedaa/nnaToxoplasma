#ifndef NEURAL_NEURALNETWORK_H_
	#define NEURAL_NEURALNETWORK_H_
		...
		class NeuralNetwork
		{
			public:
				...
				double predictAllForScore(const Dataset& dataset, Datatype d = Datatype::TEST, int limit = -1);
